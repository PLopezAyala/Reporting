...
using("pander", "knitr", "rmarkdown", "tinytex", "dplyr", "glue", "Hmisc", "rms", "summarytools", "ggplot2", "gt", "gtsummary", "consort", "htmlwidgets") #packages I used for this report. Package pander and knitr are required for R Markdown. Package tinytex only if you want to knit to pdf.
...
Yes, you can insert equations in R Markdown with LaTeX notation. Take a look at different [LaTeX symbols](https://oeis.org/wiki/List_of_LaTeX_mathematical_symbols).
